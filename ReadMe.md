...
{ 
    "62": { 
        ...
        "lcsh": [
            ...
            "Carter, John (Fictitious character) -- Fiction",
            "Dejah Thoris (Fictitious character) -- Fiction",
            "Mars (Planet) -- Fiction","Princesses -- Fiction"
        ],
        "rights": "http:\/\/www.gutenberg.org\/license",
        "title": "A Princess of Mars",
    }
...
If you want to know more, Wikipedia has a lot of good YAML examples and explanations on its [page on YAML](http://en.wikipedia.org/wiki/YAML).
